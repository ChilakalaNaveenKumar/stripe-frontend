...
import { h as destr, i as defu } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-B-cfHMjM.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const _Error404 = defineAsyncComponent(() => import('./error-404-Bg7N4Mhl.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-Bc5GH75_.mjs'));
